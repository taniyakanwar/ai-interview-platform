// Register.tsx
// NooK — cozy split-screen register page
// Same layout as Login: branded left panel + form on right
...
function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      login(token, user)        // log the user in immediately after registering
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#FAF7F2] font-sans">
      ...
      >
        ...
        {/* Swaying plant illustration — same as Login */}
        <motion.div
        ...
        <div className="w-full max-w-sm">
          ...
          >
            ...
            <p className="text-[#8B8378] text-sm">
              ...
              <Link to="/login" className="text-[#4A6B52] font-medium underline underline-offset-2 hover:text-[#3A5641] transition-colors">
                Log in
              </Link>
            </p>
          </motion.div>
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-[#A8A096] text-xs">or sign up with</span>
            <div className="flex-1 h-px bg-[#E5DFD5]" />
          </div>
